...
const PokemonDetails = (props: Props) => {
  ...
  useEffect(() => {
    ...
    return () => {
      dispatch(resetPokemonDetailsState());
    };
  }, []);
  ...
  return (
    <div className={`bg-${pokemonTheme} p-2 ${isLoading && "vh-100"}`}>
      {isLoading ? (
        <Loader />
      ) : (
        <div
          className={`col-lg-8 mx-auto ${
            fetchPokemonsDetailsResponse.isError || (isLoading && "vh-100")
          }`}
        >
          ...
          <div className="pokemon-details bg-white position-relative">
            {!fetchPokemonsDetailsResponse.isError ? (
                  ...
                  <div className="py-3">
                    <div className="row">
                      ...
                      <div className="col-4 text-center d-flex align-items-center justify-content-center flex-column">
                        ...
                        <div>
                          <h6 className="mb-0 text-secondary mt-3">
                            Special Move
                          </h6>
                        </div>
                      </div>
              ...
              <>
                <h1 className="display-4 fw-bold text-center pb-4">
                  {params.pokemonName} is not a pokemon.
                </h1>
              </>
            )}
          </div>
